...
<body>
  ...
  <div class="container-fluid mt-5">
    <div class="card text-center" style=" box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)">
      <div class="card-body">
        <p class="h3 lead mb-4 "><strong>İLAN ARAMA</strong> </p>
        <div class="row">
          <div class="ilann mx-auto" style="width: 24.2rem;">

            <form>

              <div class="form-group">
                <div class="input-group-prepend">
                  <button class="btn btn-success dropdown-toggle rounded" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Konut</button>
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="#">Konut</a>
                    <a class="dropdown-item" href="#">İşyeri</a>
                    <a class="dropdown-item" href="#">Arsa</a>
                  </div>
                  <input type="text" class="ml-3 form-control" placeholder="Gayrimenkul Arayın..."> <button type="submit" class="btn btn-success rounded ml-3">ARA</button>
                </div>
            </form>
          </div>
        </div>
