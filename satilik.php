    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="row">
          ...
          if ($ktgr == "konut") {
            $listelenen = 15;
            $sayi = $db->query("SELECT * FROM tbl_ilan WHERE ilan_Kategori='konut' and ilan_Durum='satilik'");
            if ($sayi->rowCount() > 0)
              $sayi = $sayi->rowCount();
      ...
      and
     ilan_Durum='satilik' order by ilan_Fiyat asc LIMIT $limit,$listelenen") as $gelen) {
        ...
        <a href="<?php echo $seourl . '-' . $gelen['ilan_numarasi']; ?>">
          ...
          <div class="card-footer ">
            ...
            foreach ($db->query("select * from tbl_ilan where  ilan_Kategori='konut'
    and
   ilan_Durum='satilik' order by ilan_Fiyat desc LIMIT  $limit, $listelenen ") as $gelen) {
        ...
        <a href="<?php echo $seourl . '-' . $gelen['ilan_numarasi']; ?>">
          ...
          <div class="card-footer ">
            ...
            foreach ($db->query("select * from tbl_ilan where  ilan_Kategori='konut'
  and
  ilan_Durum='satilik' order by ilan_YayinTarihi desc LIMIT  $limit, $listelenen ") as $gelen) {
        ...
        <a href="<?php echo $seourl . '-' . $gelen['ilan_numarasi']; ?>">
          ...
          <div class="card-footer ">
            ...
            foreach ($db->query("select * from tbl_ilan where  ilan_Kategori='konut'
                        and
                       ilan_Durum='satilik'LIMIT  $limit, $listelenen ") as $gelen) {
        ...
        <a href="<?php echo $seourl . '-' . $gelen['ilan_numarasi']; ?>">
          ...
          $listelenen = 15;
          $sayi = $db->query("SELECT * FROM tbl_ilan WHERE ilan_Kategori='arsa' and ilan_Durum='satilik'");
          if ($sayi->rowCount() > 0)
            $sayi = $sayi->rowCount();
          $toplamsayfa     = ceil($sayi / $listelenen);
          $sayfa = isset($_GET['sayfa']) ? (int)$_GET['sayfa'] : 1;
...
ilan_Durum='satilik' order by ilan_YayinTarihi desc LIMIT  $limit, $listelenen ") as $gelen) {
        ...
        ?>
          ...
          <?php if ($ktgr == "isyeri") {
            ...
            $sayi = $db->query("SELECT * FROM tbl_ilan WHERE ilan_Kategori='isyeri' and ilan_Durum='satilik'");
            if ($sayi->rowCount() > 0)
              $sayi = $sayi->rowCount();
            $toplamsayfa     = ceil($sayi / $listelenen);
            $sayfa = isset($_GET['sayfa']) ? (int)$_GET['sayfa'] : 1;
